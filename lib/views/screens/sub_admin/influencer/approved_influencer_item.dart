...
class ApprovedInfluencerItem extends StatefulWidget {
  final String name;
  ...
  @override
  State<ApprovedInfluencerItem> createState() => _ApprovedInfluencerItemState();
}

class _ApprovedInfluencerItemState extends State<ApprovedInfluencerItem> {
